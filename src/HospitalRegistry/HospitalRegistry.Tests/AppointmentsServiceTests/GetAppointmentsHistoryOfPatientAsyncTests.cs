...
{
    [Fact]
    public async Task GetAppointmentsHistoryOfPatientAsync_SpecificationIsNull_ThrowsArgumentNullException()
    {
        // Arrange
        ...
        {
            // Act
            var history = await service.GetAppointmentsHistoryOfPatientAsync(idToPass, specifications);
        };
    ...
    [InlineData(1, 2)]
    [InlineData(2, 3)]
    public async Task GetAppointmentsHistoryOfPatientAsync_ValidId_ReturnsAppointmentsHistory(int pageSize, int pageNumber)
    {
        // Arrange
        ...
        // Act
        var history = await service.GetAppointmentsHistoryOfPatientAsync(patient.Id, specifications);
